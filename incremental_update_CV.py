...
print(os.getcwd())
if not os.path.exists('/home/karanverma/live_algo_logs/CV/score_logs/'):
    os.makedirs('/home/karanverma/live_algo_logs/CV/score_logs/')
...
hdlr = logging.FileHandler(
    '/home/karanverma/live_algo_logs/CV/score_logs/' + str(datetime.datetime.today().date()) + '.log')
