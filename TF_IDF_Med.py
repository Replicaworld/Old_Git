...
# In[158]:
print('Starting of TF_IDF_Med Clustering Update')
import logging
import datetime
import time
import os
...
print(os.getcwd())
if not os.path.exists('/home/Gourav/Live_Algorithms/TF_IDF_Med/Clustering_logs/'):
    os.makedirs('/home/Gourav/Live_Algorithms/TF_IDF_Med/Clustering_logs/')
...
hdlr = logging.FileHandler(
    '/home/Gourav/Live_Algorithms/TF_IDF_Med/Clustering_logs/' + str(datetime.datetime.today().date()) + '.log')
