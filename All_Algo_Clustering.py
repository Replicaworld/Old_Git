...
# In[158]:
print('Starting of CV_High Clustering Update')
import logging
import datetime
import time
import os
...
print(os.getcwd())
if not os.path.exists('/home/Gourav/Live_Algorithms/All_Algo/Clustering_logs/'):
    os.makedirs('/home/Gourav/Live_Algorithms/All_Algo/Clustering_logs/')
...
hdlr = logging.FileHandler(
    '/home/Gourav/Live_Algorithms/All_Algo/Clustering_logs/' + str(datetime.datetime.today().date()) + '.log')
...
Log("Exectution finished successfully CV_High, in : %s minutes, %s seconds " % (int((time.time() - start_time_algo) / 60), int((time.time() - start_time_algo) % 60)), flag=True)
...
Log("Exectution finished successfully TF_IDF_High, in : %s minutes, %s seconds " % (int((time.time() - start_time_algo) / 60), int((time.time() - start_time_algo) % 60)), flag=True)
...
Log("Exectution finished successfully RoBerta_Base, in : %s minutes, %s seconds " % (int((time.time() - start_time_algo) / 60), int((time.time() - start_time_algo) % 60)), flag=True)
...
Log("Exectution finished successfully CV_Med, in : %s minutes, %s seconds " % (int((time.time() - start_time_algo) / 60), int((time.time() - start_time_algo) % 60)), flag=True)
...
Log("Exectution finished successfully TF_IDF_Med, in : %s minutes, %s seconds " % (int((time.time() - start_time_algo) / 60), int((time.time() - start_time_algo) % 60)), flag=True)
...
Log("Exectution finished successfully CV_Low, in : %s minutes, %s seconds " % (int((time.time() - start_time_algo) / 60), int((time.time() - start_time_algo) % 60)), flag=True)
...
Log("Exectution finished successfully TF_IDF_Low, in : %s minutes, %s seconds " % (int((time.time() - start_time_algo) / 60), int((time.time() - start_time_algo) % 60)), flag=True)
# In[ ]:


Log("All Exectution finished successfully, in : %s minutes, %s seconds " % (int((time.time() - start_time) / 60), int((time.time() - start_time) % 60)), flag=True)
