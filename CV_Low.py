...
# In[158]:
print('Starting of CV_Low Clustering Update')
import logging
import datetime
import time
import os
...
print(os.getcwd())
if not os.path.exists('/home/Gourav/Live_Algorithms/CV_Low/Clustering_logs/'):
    os.makedirs('/home/Gourav/Live_Algorithms/CV_Low/Clustering_logs/')
...
hdlr = logging.FileHandler(
    '/home/Gourav/Live_Algorithms/CV_Low/Clustering_logs/' + str(datetime.datetime.today().date()) + '.log')
