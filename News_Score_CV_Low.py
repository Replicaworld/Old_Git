...
print(os.getcwd())
if not os.path.exists('/home/Gourav/Live_Algorithms/CV_Low/score_logs/'):
    os.makedirs('/home/Gourav/Live_Algorithms/CV_Low/score_logs/')
...
hdlr = logging.FileHandler(
    '/home/Gourav/Live_Algorithms/CV_Low/score_logs/' + str(datetime.datetime.today().date()) + '.log')
