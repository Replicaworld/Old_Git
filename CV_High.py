...
print(os.getcwd())
if not os.path.exists('/home/Gourav/Live_Algorithms/CV_High/Clustering_logs/'):
    os.makedirs('/home/Gourav/Live_Algorithms/CV_High/Clustering_logs/')
...
hdlr = logging.FileHandler(
    '/home/Gourav/Live_Algorithms/CV_High/Clustering_logs/' + str(datetime.datetime.today().date()) + '.log')
