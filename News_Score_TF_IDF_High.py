...
print(os.getcwd())
if not os.path.exists('/home/Gourav/Live_Algorithms/TF_IDF_High/score_logs/'):
    os.makedirs('/home/Gourav/Live_Algorithms/TF_IDF_High/score_logs/')
...
hdlr = logging.FileHandler(
    '/home/Gourav/Live_Algorithms/TF_IDF_High/score_logs/' + str(datetime.datetime.today().date()) + '.log')
