...
# In[158]:
print('Starting of Clustering Update')
import logging
import datetime
import time
import os
...
suffixes = ['TF_IDF_High','TF_IDF_Med','TF_IDF_Low']
...
Log("Exectution finished successfully, in : %s minutes, %s seconds " % (int((time.time() - start_time_all) / 60), int((time.time() - start_time_all) % 60)), flag=True)
