...
print(os.getcwd())
if not os.path.exists('/home/Gourav/TF_IDF/logs/'):
    os.makedirs('/home/Gourav/TF_IDF/logs/')
...
hdlr = logging.FileHandler(
    '/home/Gourav/TF_IDF/logs/' + str(datetime.datetime.today().date()) + '.log')
...
df_temp=abcset.filter(abcset.set_typ == 'tfidf').select(['deviceid']).distinct()
